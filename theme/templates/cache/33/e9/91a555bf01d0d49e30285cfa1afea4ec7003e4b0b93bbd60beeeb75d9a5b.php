...
/* index.html */
class __TwigTemplate_33e991a555bf01d0d49e30285cfa1afea4ec7003e4b0b93bbd60beeeb75d9a5b extends Twig_Template
{
...
\t\t\t\t\t\t\t\t ";
        // line 90
        echo twig_escape_filter($this->env, (isset($context["femaleno"]) ? $context["femaleno"] : null), "html", null, true);
        echo " #
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"desc\">
\t\t\t\t\t\t\t\t Γυναίκες 
...
\t\t\t\t\t\t\t\t ";
        // line 108
        echo twig_escape_filter($this->env, (isset($context["maleno"]) ? $context["maleno"] : null), "html", null, true);
        echo " #
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"desc\">
\t\t\t\t\t\t\t\tΆνδρες 
...
\t\t\t\t\t\t\t\t ";
        // line 126
        echo twig_escape_filter($this->env, (isset($context["bdayno"]) ? $context["bdayno"] : null), "html", null, true);
        echo " #
\t\t\t\t\t\t\t</div>
\t\t\t\t\t\t\t<div class=\"desc\">
\t\t\t\t\t\t\t\tΈχουν Γεννέθλια 
